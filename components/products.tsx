  ...
  return (
    <section className="py-16 bg-black relative overflow-hidden">
      <div className="container flex justify-center mx-auto">
        ...
        <div className="flex flex-col gap-3 justify-center items-start mb-8">
          <h2 className="text-start text-5xl md:text-6xl font-extrabold text-white">
        ...
        <motion.div
          className="absolute top-1/2 left-2/3 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[420px] rounded-full z-0 pointer-events-none"
          style={{
        ...
        <div className="flex justify-center items-center px-4 md:px-20 gap-6 flex-wrap relative z-10">
          <motion.div
            whileHover={{ scale: 1.05 }}
            transition={{ type: "spring", stiffness: 300 }}
            className="relative"
          >
            <div className="relative p-6 md:p-8 min-h-[320px] flex flex-col justify-between bg-[#fcfcfc] text-black w-[320px] shadow-xl  transition duration-300 ease-in-out">
              {/* Ribbon */}
