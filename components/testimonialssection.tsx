    ...
    <section className="relative px-4 py-16 md:py-24 bg-black">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mb-8 md:mb-16">
          ...
          >
            <path
              d="M11.715 0.557948L9.04492 0.566406L9.27116 79.3038L11.9412 79.2953L11.715 0.557948Z"
              fill="white"
            ></path>
            <path
              d="M10.9089 91.8633L1.92589 72.809L19.5977 72.6664L10.9089 91.8633Z"
              fill="#ED89A6"
            ></path>
            <path
