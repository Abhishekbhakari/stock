  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#121421]">
      ...
      <main className="container py-12">
        ...
        <section className="mb-12 bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-4 text-[#121421]">Trend of monthly disposal of complaints</h2>
          <div className="space-y-8 text-gray-700">
            ...
            <h2 className="text-2xl font-semibold mb-4 text-[#121421]">Trend of annual disposal of complaints</h2>
            <Table className="w-full">
              <TableHeader>
                <TableRow>
                  <TableHead>Sr. No.</TableHead>
            ...
            <Table className="w-full">
              ...
              <TableBody>
                <TableRow>
                  <TableCell>Service Related</TableCell>
                  <TableCell>7 days</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Research Quality</TableCell>
